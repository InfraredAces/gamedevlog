...
const Darkmode = ({ displayClass, cfg }) => {
  return _jsxs("div", {
    ...
    children: [
      _jsx("input", { class: "toggle", id: "darkmode-toggle", type: "checkbox", tabIndex: -1 }),
      _jsx("label", {
        ...
        children: _jsxs("svg", {
          ...
          xmlSpace: "preserve",
          children: [
            _jsx("title", { children: i18n(cfg.locale).components.themeToggle.darkMode }),
            _jsx("path", {
      ...
      _jsx("label", {
        ...
        children: _jsxs("svg", {
          ...
          xmlSpace: "preserve",
          children: [
            _jsx("title", { children: i18n(cfg.locale).components.themeToggle.lightMode }),
            _jsx("path", {

  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("button", {
        ...
        children: [
          _jsx("h3", { children: i18n(cfg.locale).components.tableOfContents.title }),
          _jsx("svg", {
...
const LegacyTableOfContents = ({ fileData, cfg }) => {
  ...
  return _jsxs("details", {
    id: "toc",
    open: !fileData.collapseToc,
    children: [
      _jsx("summary", {
        children: _jsx("h3", { children: i18n(cfg.locale).components.tableOfContents.title }),
      }),
      _jsx("ul", {
        children: fileData.toc.map((tocEntry) =>
          _jsx(

...
export default (userOpts) => {
  const RecentNotes = ({ allFiles, fileData, displayClass, cfg }) => {
    ...
    return _jsxs("div", {
      ...
      children: [
        _jsx("h3", { children: opts.title ?? i18n(cfg.locale).components.recentNotes.title }),
        _jsx("ul", {
          class: "recent-ul",
              ...
              children: _jsxs("div", {
                ...
                children: [
                  ...
                  page.dates &&
                    _jsx("p", {
                      class: "meta",
                      children: _jsx(Date, { date: getDate(cfg, page), locale: cfg.locale }),
                    }),
                  _jsx("ul", {
                    class: "tags",
        ...
        opts.linkToMore &&
          ...
          _jsx("p", {
            children: _jsx("a", {
              ...
              children: i18n(cfg.locale).components.recentNotes.seeRemainingMore({ remaining }),
            }),
          }),
      ],
    })
